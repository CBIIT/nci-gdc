...
for row in rows:
    sql = """INSERT INTO node__field_end_date (bundle, deleted, entity_id, revision_id, langcode, delta, field_end_date_value) VALUES (%s, %s, %s, %s, %s, %s, %s)"""
    data = (row[1], row[2], row[3], row[4], row[5], row[6], row[8])  # Create a tuple with data values
