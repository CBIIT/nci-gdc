...
/**
 * Filter to display unique community tool years in a dropdown.
 *
 * @ingroup views_filter_handlers
 *
 * @ViewsFilter("community_tool_year_filter")
 */
class CommunityToolYearFilter extends InOperator
{
    /**
     * {@inheritdoc}
     */
    ...
    public function getValueOptions()
    {
        ...
        $this->valueOptions = [];
        $query =
            "SELECT DISTINCT(DATE_FORMAT(FROM_UNIXTIME(field_date_value),'%Y')) as release_year FROM node__field_date where bundle='community_tool' order by release_year desc";
